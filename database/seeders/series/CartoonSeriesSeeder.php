...
class CartoonSeriesSeeder extends ContentSeeder implements SeriesContent, ContentWithDownloadableThumbnails, PlayerTypeInterface
{
    use SeriesCreation, DownloadableThumbnails, VariablePlayerType;
    private const SERIES_FILE_PATH = 'database\seeders\series\CartoonSeries.php';
